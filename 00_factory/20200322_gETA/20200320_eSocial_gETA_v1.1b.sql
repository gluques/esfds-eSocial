...
-------------------------------------------------------
SET appParam.lstNumExpedients TO '{00002/2019/89, 00002/2019/173, 00002/2019/192, 00002/2019/68, 00002/2019/38,
...
-------------------------------------------------------
CREATE OR REPLACE PROCEDURE mostrarSumImportsActivitats(nominaId INTEGER, dataUltNomina TIMESTAMP) AS $$
DECLARE	
	importTotal DECIMAL;
	importFins 	DECIMAL;
BEGIN		
...
-------------------------------------------------------
CREATE OR REPLACE PROCEDURE mostrarSumImportsDretsTeorics(dretId INTEGER, dataUltNomina TIMESTAMP) AS $$
DECLARE	
	importTotal DECIMAL;
	importFins 	DECIMAL;
BEGIN		
...
-- Procedure mostrarSumImportsDretsTeorics()
-------------------------------------------------------
CREATE OR REPLACE PROCEDURE mostrarSumImportsPercebuts(nominaId INTEGER, dataUltNomina TIMESTAMP) AS $$
DECLARE	
	importTotal DECIMAL;
	importFins 	DECIMAL;
BEGIN		
...
-------------------------------------------------------
CREATE OR REPLACE PROCEDURE mostrarSumImportsLiquidats(nominaId INTEGER, dataUltNomina TIMESTAMP) AS $$
DECLARE	
	importTotal DECIMAL;
	importFins 	DECIMAL;
BEGIN		
